...
export const Hero = () => {
  ...
  return <section className="relative py-8 lg:py-12 overflow-hidden bg-gradient-to-br from-background via-primary/5 to-background">
      <div className="container mx-auto px-4 relative">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="flex justify-center mb-6">
            <Button size="lg" onClick={scrollToTools} className="bg-gradient-to-r from-orange-500 to-red-500 hover:from-orange-600 hover:to-red-600 text-white shadow-lg hover:shadow-xl transition-all transform hover:scale-105 focus:ring-4 focus:ring-orange-500/50 px-8 py-3 text-lg animate-scale-in" aria-label="Start processing PDF files for free">
