...
export const ToolsGrid = ({ filter, showTitle = true }: ToolsGridProps) => {
  ...
  const getSectionDescription = () => {
    ...
    switch (filter) {
      ...
      case "ai": return "Leverage artificial intelligence for advanced PDF processing, OCR, translation, and analysis";
        ...
        {showTitle && (
          <div className="text-center mb-12">
            <div className="flex items-center justify-center mb-4">
              ...
              <span className="text-sm font-medium text-primary">25+ Professional Tools • Fast & Secure • Easy to Use</span>
          ...
          <div className="text-center mt-16">
            <div className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 rounded-full border">
              ...
              <span className="text-sm font-medium text-foreground">
                Advanced PDF processing • Secure & Fast • Professional Quality • SEO Optimized
              </span>
            </div>
          </div>
        )}
